...
<div id="edit-qc-data-1-modal" class="modal fade" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="edit-patient-details-form">
                    <input type="hidden" id="qc_data_id_edit" name="qc_data_id_edit" class="form-control form-control-solid form-control-sm">
                    <input type="hidden" id="qc_id_edit" name="qc_id_edit" class="form-control form-control-solid form-control-sm">
                    ...
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input class="form-control form-control-solid form-control-sm daterange-picker" placeholder="Pick date range" id="date_edit" name="date_edit" />
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="qc_data_edit" name="qc_data_edit" class="form-control form-control-solid form-control-sm" onfocusout="QCDataonFocusOutEdit1()">
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="position_edit" name="position_edit" class="form-control form-control-solid form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="number" id="qc_edit" name="qc_edit" class="form-control form-control-solid form-control-sm">
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="atlm_edit" name="atlm_edit" value="{{ Auth::user()->name }}" class="form-control form-control-solid form-control-sm" readonly>
                        </div>
                    </div>
                    <div class="fv-row row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="text" id="recommendation_edit" name="recommendation_edit" class="form-control form-control-solid form-control-sm">
                        </div>
                    </div>
                ...
                <div class="mb-2 mt-8">
                    <button type="button" id="button_update_data" class="form-control btn btn-light-success" data-qc-id-1="" data-qc-id-2="" data-qc-id-3=""> Update QC Data </button>
