                ...
                <div class="card card-docs mb-2">
                    ...
                    <div class="card-body fs-6 py-15 px-5 py-lg-8 px-lg-8 text-gray-700">
                        ...
                        <div class="p-2">
                            ...
                            <div class="mb-4">
                                <small><label class="form-label fs-6">Specimen Name</label></small>
                                {{ Form::text('name', null, ['class' => 'form-control form-control-solid form-control-sm', 'id' => 'first-input']) }}
                            </div>
                            <div class="mb-4">
                                <label class="form-label fs-6">Color</label>
                                {{ Form::select('color', array_replace(Helper::specimenColor(),[''=>'']), null, ['class' => 'form-select form-select-sm form-select-solid select-two', 'data-control' => 'select2', 'data-placeholder' => 'Select color']) }}
                            </div>
                            <div class="mb-8">
