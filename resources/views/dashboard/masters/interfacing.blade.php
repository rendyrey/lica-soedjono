                    ...
                    <div class="card-body fs-6 py-15 px-5 py-lg-8 px-lg-8 text-gray-700">
                        ...
                        <div class="p-2">
                            ...
                            <div id="package-list" class="mb-4">
                              <label class="form-label fs-6 required">Analyzer</label>
                                          ...
                                          <div data-repeater-item>
                                              <div class="form-group row mb-2">
                                                  <div class="col-md-5">
                                                      ...
                                                      {{ Form::select('test_id', [], null, ['class' => 'form-select form-select-sm form-select-solid select-two select-test','required'=>true, 'data-control' => 'select2', 'data-placeholder' => 'Select test']) }}
                                                  </div>
                                                  <div class="col-md-5">
                                                      <label class="form-label required">Code</label>
                                                      {{ Form::text('code', null, ['class' => 'form-control form-control-solid form-control-sm','required'=>true]) }}
                                                  </div>
                                                  <div class="col-md-2">
...
<div id="modal_form_horizontal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="mb-8">
                <label class="form-label fs-6 required">Code</label>
                {{ Form::text('code', null, ['class' => 'form-control form-control-solid form-control-sm','required'=>true]) }}
            </div>
            <div class="mb-2 mt-8">
                {{ Form::submit('Update ' . $masterData, ['class' => 'form-control btn btn-light-success','required'=>true]) }}
            </div>
