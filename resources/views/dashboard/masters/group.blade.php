                            ...
                            <table class="table gy-1 align-middle table-striped px-0 datatable-ajax">
                                <thead>
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        <th>Group Name</th>
                                        <th>Code</th>
                                        <th>Target TAT (Minutes)</th>
                                        <th>Target TAT CITO (Minutes)</th>
            ...
            <div class="card card-docs mb-2">
                ...
                <div class="card-body fs-6 py-15 px-5 py-lg-8 px-lg-8 text-gray-700">
                    ...
                    <div class="p-2">
                        ...
                        <div class="mb-4">
                            <label class="form-label fs-6">Target TAT</label>
                            {{ Form::text('target_tat', null, ['class' => 'form-control form-control-solid form-control-sm']) }}
                        </div>
                        <div class="mb-4">
                            <label class="form-label fs-6">Target TAT CITO</label>
                            {{ Form::text('target_tat_cito', null, ['class' => 'form-control form-control-solid form-control-sm']) }}
                        </div>
                        <div class="mb-2 mt-8">
