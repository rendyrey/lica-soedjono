...
<body>
    ...
    <div>
        <h3>REGISTER HASIL PEMERIKSAAN RAPID HIV</h3>
        <table>
            <tr>
        ...
        <table id="tb_result" style="border: 1px solid black; margin: 5px; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" style="text-align: center;">M R</th>
                    <th class="border-bottom" style="text-align: center;">Nama</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center; border: 1px solid black; border-collapse: collapse;">{!! $data->test_name_merge !!}</td>
