                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/bpjs-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="5%">Room Name</th>
                                            <th class="text-start" width="10%">Test Name</th>
                                            <th class="text-start" width="25%">Price</th>
...
<script src="{{asset('js/report/report_bpjs/index.js')}}"></script>
<script src="{{asset('js/report/report_bpjs/datatable.js')}}"></script>
