                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/flebotomi-sampling-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['Sampling & Phlebotomy Report'], 'Sampling-Phlebotomy-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-docs-table-filter="search-datatable-flebotomi" class="form-control form-control-sm form-control-solid w-250px ps-15" placeholder="Search" />
                                    </div>
                                    <!--end::Search-->
                                    <!--begin::Group actions-->
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="15%">Phyisican</th>
                                            <th class="text-start" width="10%">Room Name</th>
                                            <th class="text-start" width="15%">Sampling By</th>
                                            <th class="text-start" width="10%">Draw Time</th>
                                        </tr>
                                    </thead>
...
<script src="{{asset('js/report/report_flebotomi_sampling/index.js')}}"></script>
<script src="{{asset('js/report/report_flebotomi_sampling/datatable.js')}}"></script>
