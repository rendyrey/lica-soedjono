                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/analyzer-print')}}" class="btn btn-sm btn-light btnPrint">Print Default Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['Analyzer Report'], 'Analyzer-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="10%">Analyzer ID</th>
                                            <th class="text-start" width="40%">Analyer Name</th>
...
<script src="{{asset('js/report/report_analyzer/index.js')}}"></script>
<script src="{{asset('js/report/report_analyzer/datatable.js')}}"></script>
