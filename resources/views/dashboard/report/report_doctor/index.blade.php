                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/doctor-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['Doctor-Report'], 'Doctor-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="">
                                            {{ Form::select('doctor_id', [], null, ['class' => 'form-select form-select-sm form-select-solid select-two select-doctor','required'=>true, 'data-control' => 'select2', 'data-placeholder' => 'Select Doctor','id'=>'doctor_id']) }}
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-docs-table-filter="search-datatable-doctor" class="form-control form-control-sm form-control-solid w-250px ps-15" placeholder="Search" />
                                    </div>
                                    <!--end::Search-->
                                    <!--begin::Group actions-->
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="10%">Doctor Name</th>
                                            <th class="text-start" width="10%">Patient Total</th>
                                        </tr>
                                    </thead>
...
<script src="{{asset('js/report/report_doctor/index.js')}}"></script>
<script src="{{asset('js/report/report_doctor/datatable.js')}}"></script>
