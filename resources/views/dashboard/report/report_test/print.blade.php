...
<body>
    ...
    <div>
        <h3>LAPORAN JUMLAH TINDAKAN LABORATORIUM</h3>
        <table>
            <tr>
        ...
        <table id="tb_result" style="border: 1px solid black; margin: 5px; border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom" style="text-align: center;">ID Tes</th>
                    <th class="border-bottom" style="text-align: center;">Nama Tes</th>
                    <th class="border-bottom" style="text-align: center;">Jumlah</th>
                </tr>
            </thead>
            <tbody>
                @php
