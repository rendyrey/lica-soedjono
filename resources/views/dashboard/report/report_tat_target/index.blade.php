                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/tat-target-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['TAT Target Report'], 'TAT-Target-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="10%">Group Name</th>
                                            <th class="text-start" width="8%">Total</th>
                                            <th class="text-start" width="8%">Target TAT (Minutes)</th>
                                            <th class="text-start" width="8%">(< Target)</th>
                                            <th class="text-start" width="8%">(> Target)</th>
                                        </tr>
                                    </thead>
...
<script src="{{asset('js/report/report_tat_target/index.js')}}"></script>
<script src="{{asset('js/report/report_tat_target/datatable.js')}}"></script>
