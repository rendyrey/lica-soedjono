                        ...
                        <div class="p-0">
                            ...
                            <div class="py-5">
                                ...
                                <div class="d-flex justify-content-between mb-5">
                                    <div class="col-lg-3">
                                        <button type="button" id="print-report" href="{{url('report/user-process-print')}}" class="btn btn-sm btn-light btnPrint">Print Report</button>
                                        <button type="button" id="export-report" class="btn btn-sm btn-light" onclick="tablesToExcel(['datatables'], ['User Process Report'], 'User-Process-Report.xls', 'Excel')">Export Excel</button>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <table class="table gy-1 align-middle table-striped px-0 datatable-ajax" id="datatables">
                                    <thead>
                                        <tr class="text-start text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-start" width="5%">No Lab</th>
                                            <th class="text-start" width="15%">Test Name</th>
                                            <th class="text-start" width="15%">Checkin User</th>
                                            <th class="text-start" width="15%">Draw User</th>
                                            <th class="text-start" width="15%">Process User</th>
                                            <th class="text-start" width="15%">Ver User</th>
                                            <th class="text-start" width="15%">Val User</th>
                                        </tr>
                                    </thead>
...
<script src="{{asset('js/report/report_user_process/index.js')}}"></script>
<script src="{{asset('js/report/report_user_process/datatable.js')}}"></script>
