...
var columnsDataTable = [
    ...
    {data: 'patient_gender', name: 'finish_transactions.patient_gender',
        render: function (data, type, row, meta) {
            var gender;
    ...
    { data: 'test_name' },
    { data: 'result', name: 'finish_transaction_tests.global_result'},
    { data: 'result_duplo', name: 'finish_transaction_tests.global_result'}
  ...
  var Datatable = function () {
    ...
    var initDatatable = function () {
        dt = $(selectorName).DataTable({
            ...
            stateSave: false,
            ajax: {
                url: baseUrl('report/duplo-datatable/')
            },
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-docs-table-filter="search-datatable-duplo"]');
