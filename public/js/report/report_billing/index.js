...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      const url = baseUrl('report/billing-datatable/'+startDate+'/'+endDate+'/'+insurance_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/billing-print/'+startDate+'/'+endDate+'/'+insurance_id))
  });
