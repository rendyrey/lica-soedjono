...
var columnsDataTable = [
    ...
    {data: 'total_patient', name: 'finish_transactions.patient_id'}
  ...
  var Datatable = function () {
    ...
    var initDatatable = function () {
        dt = $(selectorName).DataTable({
            ...
            stateSave: false,
            ajax: {
                url: baseUrl('report/doctor-datatable/')
            },
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-docs-table-filter="search-datatable-doctor"]');
