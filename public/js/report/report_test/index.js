...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      const url = baseUrl('report/test-datatable/'+startDate+'/'+endDate+'/'+test_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/test-print/'+startDate+'/'+endDate+'/'+test_id))
  });
...
var Select2ServerSide = function (theData = 'test', searchKey = 'name') {
