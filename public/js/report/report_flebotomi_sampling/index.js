...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      const url = baseUrl('report/flebotomi-sampling-datatable/'+startDate+'/'+endDate+'/'+specimen_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/flebotomi-sampling-print/'+startDate+'/'+endDate+'/'+specimen_id))
  });
