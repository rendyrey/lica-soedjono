...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      const url = baseUrl('report/patient-detail-datatable/'+startDate+'/'+endDate+'/'+patient_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/patient-detail-print/'+startDate+'/'+endDate+'/'+patient_id))
  });
