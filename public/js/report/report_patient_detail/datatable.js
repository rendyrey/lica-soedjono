  ...
  var Datatable = function () {
    ...
    var initDatatable = function () {
        dt = $(selectorName).DataTable({
            ...
            stateSave: false,
            ajax: {
                url: baseUrl('report/patient-detail-datatable/')
            },
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-docs-table-filter="search-datatable-patient-detail"]');
