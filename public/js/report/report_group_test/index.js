...
var DateRangePicker = () => {
  ...
  $("#daterange-picker").on('change', function () {
      ...
      const url = baseUrl('report/group-test-datatable/'+startDate+'/'+endDate+'/'+group_id);
      Datatable.refreshTableAjax(url);

      $('#print-report').attr("href", baseUrl('report/group-test-print/'+startDate+'/'+endDate+'/'+group_id))
  });
